...
const MASTER_FEATURE_INVENTORY: FeatureItem[] = [
  ...
  { id: 'f-604', category: '6. Shipyard & Fleet', name: '🏺 Stargate Relics & TV/Movie Artifact Citadel', status: 'IMPLEMENTED', route: 'stargate-relics', description: '22 canonical Stargate show & movie artifacts (ZPM, Eye of Ra, Sangreal, Ark of Truth, Dakara Wave, Asgard Core) with 6 socket slots, active powers, and Dakara crucible fusion.', specs: 'StargateRelicsView.tsx' },
